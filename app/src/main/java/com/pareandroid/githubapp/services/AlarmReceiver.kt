package com.pareandroid.githubapp.services
...
import com.pareandroid.githubapp.ui.MainActivity
import java.util.*
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun shoAlarm(context: Context) {
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setLargeIcon(
                BitmapFactory.decodeResource(
                    context.resources,
                    R.drawable.ic_baseline_access_alarm_48
                )
            )
